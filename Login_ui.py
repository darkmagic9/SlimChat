...
class Ui_Dialog_For_Login(object):
    def setupUi(self, Dialog):
        ...
        self.pbRegister.setGeometry(QtCore.QRect(440, 350, 41, 28))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.editName.setToolTip(_translate("Dialog", "请输入用户账号"))
        self.editPwd.setToolTip(_translate("Dialog", "请输入用户密码"))
        self.pbLogin.setToolTip(_translate("Dialog", "登录"))
        self.pbLogin.setText(_translate("Dialog", "登   录"))
        self.pbRegister.setToolTip(_translate("Dialog", "注册"))
        self.pbRegister.setText(_translate("Dialog", "注册"))
        self.closeBt.setToolTip(_translate("Dialog", "关闭"))
        self.minBt.setToolTip(_translate("Dialog", "最小化"))
        self.setupBt.setToolTip(_translate("Dialog", "设置"))
