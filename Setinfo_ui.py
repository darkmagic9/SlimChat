...
class Ui_Dialog_For_Setinfo(object):
    ...
    def retranslateUi(self, Dialo):
        ...
        self.editName.setToolTip(_translate("Dialo", "请输入新的昵称"))
        self.closeBt.setToolTip(_translate("Dialo", "关闭"))
        self.btDone.setToolTip(_translate("Dialo", "完成"))
        self.btDone.setText(_translate("Dialo", "完成"))
        self.label_2.setText(_translate("Dialo", "设置头像"))
        self.scanPic.setToolTip(_translate("Dialo", "浏览"))
        self.scanPic.setText(_translate("Dialo", "浏览"))
        self.label_3.setText(_translate("Dialo", "设置昵称"))
